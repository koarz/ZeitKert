...
namespace DB {
class FunctionComparison final : public Function {
public:
  enum class Operator { Less, LessOrEquals, Greater, GreaterOrEquals, Equals, NotEquals };
  ...
  Status ResolveResultType(Block &block,
