 ...
 *
 * If compiler is not gcc/clang or target isn't x86_64 or
 * ENABLE_MULTITARGET_CODE was set to OFF in cmake, all code inside these macros
 * will be removed and USE_MULTITARGET_CODE will be set to 0. Use #if
 * USE_MULTITARGET_CODE whenever you use anything from this namespaces.
 *
 ...
 * copile options. Functions and classes inside this macros are available
 * regardless of USE_MUTLITARGE_CODE.
 *
 * Example of usage:
 *
 ...
 *
 * Inside every TargetSpecific namespace there is a constexpr variable
 * BuildArch, which indicates the target platform for current code.
 *
 * Example:
 *
 ...
 *         iteration_size = 2
 *     else if constexpr (BuildArch == TargetArch::AVX || BuildArch ==
 * TargetArch::AVX2) iteration_size = 4; for (int i = 0; i < size; i +=
 * iteration_size)
 *     ...
 * }
 * ) // DECLARE_MULTITARGET_CODE
 ...
 *
 * If you want to write IFunction or IExecutableFuncionImpl with several
 * implementations see PerformanceAdaptors.h.
 */
...
#define AVX512VBMI2_FUNCTION_SPECIFIC_ATTRIBUTE                                \
  __attribute__((target("sse,sse2,sse3,ssse3,sse4,popcnt,avx,avx2,avx512f,"    \
                        "avx512bw,avx512vl,avx512vbmi,avx512vbmi2")))
#define AVX512VBMI_FUNCTION_SPECIFIC_ATTRIBUTE                                 \
  __attribute__((target("sse,sse2,sse3,ssse3,sse4,popcnt,avx,avx2,avx512f,"    \
                        "avx512bw,avx512vl,avx512vbmi")))
#define AVX512BW_FUNCTION_SPECIFIC_ATTRIBUTE                                   \
  __attribute__((                                                              \
      target("sse,sse2,sse3,ssse3,sse4,popcnt,avx,avx2,avx512f,avx512bw")))
#define AVX512_FUNCTION_SPECIFIC_ATTRIBUTE                                     \
  __attribute__((target("sse,sse2,sse3,ssse3,sse4,popcnt,avx,avx2,avx512f")))
#define AVX2_FUNCTION_SPECIFIC_ATTRIBUTE                                       \
  __attribute__((target("sse,sse2,sse3,ssse3,sse4,popcnt,avx,avx2,bmi2")))
#define AVX_FUNCTION_SPECIFIC_ATTRIBUTE __attribute__((target("sse,sse2,sse3,ssse3,sse4,popcnt,avx"))
#define SSE42_FUNCTION_SPECIFIC_ATTRIBUTE                                      \
  __attribute__((target("sse,sse2,sse3,ssse3,sse4,popcnt")))
#define DEFAULT_FUNCTION_SPECIFIC_ATTRIBUTE

#define BEGIN_AVX512VBMI2_SPECIFIC_CODE                                        \
  _Pragma("clang attribute "                                                   \
          "push(__attribute__((target(\"sse,sse2,sse3,ssse3,sse4,popcnt,avx,"  \
          "avx2,avx512f,avx512bw,avx512vl,avx512vbmi,avx512vbmi2\"))),apply_"  \
          "to=function)")
#define BEGIN_AVX512VBMI_SPECIFIC_CODE                                         \
  _Pragma("clang attribute "                                                   \
          "push(__attribute__((target(\"sse,sse2,sse3,ssse3,sse4,popcnt,avx,"  \
          "avx2,avx512f,avx512bw,avx512vl,avx512vbmi\"))),apply_to=function)")
#define BEGIN_AVX512BW_SPECIFIC_CODE                                           \
  _Pragma("clang attribute "                                                   \
          "push(__attribute__((target(\"sse,sse2,sse3,ssse3,sse4,popcnt,avx,"  \
          "avx2,avx512f,avx512bw\"))),apply_to=function)")
#define BEGIN_AVX512F_SPECIFIC_CODE                                            \
  _Pragma("clang attribute "                                                   \
          "push(__attribute__((target(\"sse,sse2,sse3,ssse3,sse4,popcnt,avx,"  \
          "avx2,avx512f\"))),apply_to=function)")
#define BEGIN_AVX2_SPECIFIC_CODE                                               \
  _Pragma("clang attribute "                                                   \
          "push(__attribute__((target(\"sse,sse2,sse3,ssse3,sse4,popcnt,avx,"  \
          "avx2,bmi2\"))),apply_to=function)")
#define BEGIN_AVX_SPECIFIC_CODE                                                \
  _Pragma("clang attribute "                                                   \
          "push(__attribute__((target(\"sse,sse2,sse3,ssse3,sse4,popcnt,"      \
          "avx\"))),apply_to=function)")
 ...
 * To prevent this warning we define this function inside every macros with
 * pragmas.
 */
...
DECLARE_DEFAULT_CODE(constexpr auto BuildArch = TargetArch::Default; /// NOLINT
                     ) // DECLARE_DEFAULT_CODE
...
DECLARE_AVX_SPECIFIC_CODE(constexpr auto BuildArch = TargetArch::AVX; /// NOLINT
 ...
 *     MULTITARGET_FUNCTION_HEADER(int), testFunctionImpl,
...
#define MULTITARGET_FUNCTION_AVX2_SSE42(FUNCTION_HEADER, name, FUNCTION_BODY)  \
  ...
  name##AVX2 FUNCTION_BODY                                                     \
                                                                               \
      FUNCTION_HEADER                                                          \
                                                                               \
          SSE42_FUNCTION_SPECIFIC_ATTRIBUTE name##SSE42 FUNCTION_BODY          \
                                                                               \
              FUNCTION_HEADER                                                  \
                                                                               \
                  name FUNCTION_BODY
...
/// NOLINTNEXTLINE
#define MULTITARGET_FUNCTION_AVX512BW_AVX512F_AVX2_SSE42(FUNCTION_HEADER,      \
                                                         name, FUNCTION_BODY)  \
  FUNCTION_HEADER                                                              \
                                                                               \
  AVX512BW_FUNCTION_SPECIFIC_ATTRIBUTE                                         \
  name##AVX512BW FUNCTION_BODY                                                 \
                                                                               \
      FUNCTION_HEADER                                                          \
                                                                               \
          AVX512_FUNCTION_SPECIFIC_ATTRIBUTE name##AVX512F FUNCTION_BODY       \
                                                                               \
              FUNCTION_HEADER                                                  \
                                                                               \
                  AVX2_FUNCTION_SPECIFIC_ATTRIBUTE name##AVX2 FUNCTION_BODY    \
                                                                               \
                      FUNCTION_HEADER                                          \
                                                                               \
                          SSE42_FUNCTION_SPECIFIC_ATTRIBUTE                    \
                              name##SSE42 FUNCTION_BODY                        \
                                                                               \
                                  FUNCTION_HEADER                              \
                                                                               \
                                      name FUNCTION_BODY
